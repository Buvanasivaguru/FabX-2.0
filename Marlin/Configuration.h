...
#define STRING_VERSION_CONFIG_H __DATE__ "15/05/15 " __TIME__ // build date and time/
#define STRING_CONFIG_H_AUTHOR "(Buvan_Redd, FabX 2.0)" // Who made the changes.*******************************************************
...
//    You must specify the X & Y coordinates of all 3 points
  ...
  // Note: this feature occupies 10'206 byte
    ...
    // is used to esimate the plane of the print bed
      ...
      #define ABL_PROBE_PT_1_Y 87
      #define ABL_PROBE_PT_2_X 55
      #define ABL_PROBE_PT_2_Y 87
      #define ABL_PROBE_PT_3_X 18
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,405.41,100}  // default steps per unit for Ultimaker
#define DEFAULT_MAX_FEEDRATE          {500, 500, 5, 25}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {9000,9000,100,10000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot.
...
//#endif
//#define SDSUPPORT
 // Enable SD Card Support in Hardware Console
