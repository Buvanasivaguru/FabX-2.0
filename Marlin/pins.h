...
#define ALARM_PIN          -1
/*
#define LCD_PINS_RS         8    // EXP2: PE0
#define LCD_PINS_ENABLE     9    // EXP2: PE1
#define LCD_PINS_D4         4    // EXP2: PD4
#define LCD_PINS_D5         5    // EXP2: PD5
#define LCD_PINS_D6         6    // EXP2: PD6
#define LCD_PINS_D7         7    // EXP2: PD7
#define BTN_EN1            16    // EXP2: PC0
#define BTN_EN2            17    // EXP2: PC1
#define BTN_ENC            18    // EXP2: PC2
*/
#ifndef SDSUPPORT
// these pins are defined in the SD library if building with SD support
